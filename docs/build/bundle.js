...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input.required = true;
    			attr_dev(input, "class", "svelte-ogcd4v");
    			add_location(input, file, 6, 2, 220);
    			attr_dev(button, "class", "-conc -active svelte-ogcd4v");
    			add_location(button, file, 7, 2, 301);
    			add_location(ul, file, 8, 2, 345);
    			attr_dev(form, "class", "-bg svelte-ogcd4v");
    			add_location(form, file, 5, 1, 155);
    		},
    ...
    // (10:3) {#each $workStarted.intervals as interval}
    function create_each_block(ctx) {
    	let li;
    	let t0_value = /*interval*/ ctx[2].ini + "";
    	let t0;
    	let t1;
    	let t2_value = /*interval*/ ctx[2].end + "";
    	let t2;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$workStarted*/ 1 && t0_value !== (t0_value = /*interval*/ ctx[2].ini + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*$workStarted*/ 1 && t2_value !== (t2_value = /*interval*/ ctx[2].end + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:3) {#each $workStarted.intervals as interval}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	let if_block_anchor;
    	let if_block = /*$workStarted*/ ctx[0] && create_if_block(ctx);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			add_location(p, file$1, 17, 2, 650);
    			attr_dev(div, "class", "-bg svelte-ovbxx9");
    			add_location(div, file$1, 16, 1, 559);
    		},
    		m: function mount(target, anchor) {
    ...
    // (12:2) {#each work.intervals as interval}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" - ");
    			t2 = text(t2_value);
    			add_location(p, file$1, 12, 3, 493);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$workList*/ 1 && t0_value !== (t0_value = /*interval*/ ctx[5].ini + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*$workList*/ 1 && t2_value !== (t2_value = /*interval*/ ctx[5].end + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(12:2) {#each work.intervals as interval}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	function submit_handler(...args) {
    		return /*submit_handler*/ ctx[1](/*work*/ ctx[2], ...args);
    	}

    	let each_value_1 = /*work*/ ctx[2].intervals;
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			attr_dev(input, "type", "text");
    			input.value = input_value_value = /*work*/ ctx[2].text;
    			input.readOnly = true;
    			attr_dev(input, "class", "svelte-ovbxx9");
    			add_location(input, file$1, 8, 3, 347);
    			attr_dev(button, "class", "-conc -active svelte-ovbxx9");
    			add_location(button, file$1, 9, 3, 399);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*$workList*/ 1 && input_value_value !== (input_value_value = /*work*/ ctx[2].text) && input.value !== input_value_value) {
    				prop_dev(input, "value", input_value_value);
    			}

    			if (dirty & /*$workList*/ 1) {
    				each_value_1 = /*work*/ ctx[2].intervals;
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const submit_handler = work => workList.start(work.id);
    	$$self.$capture_state = () => ({ slide, elasticInOut, workList, $workList });
    	return [$workList, submit_handler];
    }
    ...
    function create_fragment$2(ctx) {
    	let if_block_anchor;
    	let if_block = /*deferredInstallPrompt*/ ctx[0] && create_if_block$1(ctx);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button1, file$3, 16, 1, 463);
    			attr_dev(footer, "class", "-bg svelte-r5nvck");
    			add_location(footer, file$3, 15, 0, 441);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
